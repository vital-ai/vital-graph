...
def get_table_names(interned_id):
    _logger.info(f"🚀 get_table_names: FUNCTION STARTED with interned_id={interned_id}")
    return [
...
def create_asserted_statements_table(interned_id, metadata):
    _logger.info(f"🚀 create_asserted_statements_table: FUNCTION STARTED with interned_id={interned_id}, metadata={metadata}")
    return Table(
...
def create_type_statements_table(interned_id, metadata):
    _logger.info(f"🚀 create_type_statements_table: FUNCTION STARTED with interned_id={interned_id}, metadata={metadata}")
    return Table(
...
def create_literal_statements_table(interned_id, metadata):
    _logger.info(f"🚀 create_literal_statements_table: FUNCTION STARTED with interned_id={interned_id}, metadata={metadata}")
    return Table(
...
def create_quoted_statements_table(interned_id, metadata):
    _logger.info(f"🚀 create_quoted_statements_table: FUNCTION STARTED with interned_id={interned_id}, metadata={metadata}")
    return Table(
...
def create_namespace_binds_table(interned_id, metadata):
    _logger.info(f"🚀 create_namespace_binds_table: FUNCTION STARTED with interned_id={interned_id}, metadata={metadata}")
    return Table(
