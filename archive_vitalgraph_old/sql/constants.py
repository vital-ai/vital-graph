...
# Text search optimization constants
TEXT_SEARCH_OPTIMIZATION_ENABLED = True
TEXT_SEARCH_MIN_TERM_LENGTH = 3
TEXT_SEARCH_LITERAL_TABLE_PRIORITY = True

# New select types for optimized queries
OPTIMIZED_TEXT_SELECT = 10
SINGLE_TABLE_SELECT = 11
