...
const COMMANDS: CommandItem[] = [
  ...
  { id: 'semantic-search', label: 'Semantic Search', description: 'Test indexes via SPARQL', icon: <HiSearch className="w-5 h-5" />, path: '/semantic-search', keywords: ['vector', 'fts', 'fuzzy', 'geo', 'embedding'] },
  { id: 'index-mappings', label: 'Index Mappings', description: 'Manage index mappings', icon: <HiCube className="w-5 h-5" />, path: '/index-mappings', keywords: ['search', 'mapping', 'fuzzy'] },
  { id: 'indexes', label: 'Indexes', description: 'Vector & FTS indexes', icon: <HiCube className="w-5 h-5" />, path: '/indexes', keywords: ['vector', 'fts', 'weaviate'] },
  { id: 'geo-shapes', label: 'Geo Shapes', description: 'Geographic data', icon: <HiCube className="w-5 h-5" />, path: '/geo-shapes', keywords: ['geo', 'points', 'polygon', 'location'] },
