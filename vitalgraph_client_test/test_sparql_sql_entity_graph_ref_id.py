#!/usr/bin/env python3
"""
SPARQL-SQL Backend — Entity Graph Reference ID Regression Test

Regression test for the include_entity_graph + reference_id duplication bug.
Creates a dedicated space, runs the regression test, then cleans up.
"""
...
from vitalgraph_client_test.sparql_sql.case_entity_graph_ref_id import EntityGraphRefIdTester

# ===========================================================================
# Configuration
# ===========================================================================
TEST_SPACE_ID = "sp_sql_refid_regression"
TEST_SPACE_NAME = "SPARQL-SQL RefID Regression Test Space"
TEST_GRAPH_ID = "urn:sql_refid_regression"
...
async def main():
    print("\n" + "=" * 80)
    print("  SPARQL-SQL Backend — Entity Graph Reference ID Regression Test")
    print("=" * 80)
    ...
    try:
        ...
        space = Space(space=TEST_SPACE_ID, space_name=TEST_SPACE_NAME,
                      space_description="Regression test for entity graph ref ID duplication")
        ...
        # Run regression test
        tester = EntityGraphRefIdTester(client)
