...
def main():
    ...
    ont_uri = "http://vital.ai/ontology/haley-ai-kg#"

    # ont_uri = "http://vital.ai/ontology/chat-ai#"

    # Test specific ontology (if vital-core is available)
    test_specific_ontology(generator, ont_uri, output_dir, loaded_ontologies)
...
def test_specific_ontology(generator, ont_iri, output_dir, loaded_ontologies):
    """Test generation for a specific ontology with detailed output."""
    

    if ont_iri in loaded_ontologies:
        print(f"\n=== Detailed Test: {ont_iri} ===")
        ...
        print(f"{ont_iri} ontology not found in loaded ontologies")
