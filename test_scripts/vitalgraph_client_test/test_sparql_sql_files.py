#!/usr/bin/env python3
"""
SPARQL-SQL Backend Files Test

Standalone runner for the Files CRUD test case against the sparql_sql backend.
Creates a dedicated space, runs file metadata tests, then cleans up.
"""
...
# Configuration
# ===========================================================================
TEST_SPACE_ID = "sp_sql_files"
TEST_SPACE_NAME = "SPARQL-SQL Files Test Space"
TEST_GRAPH_ID = "urn:sql_files"
...
async def main():
    print("\n" + "=" * 80)
    print("  SPARQL-SQL Backend — Files CRUD Test")
    print("=" * 80)
    ...
    try:
        ...
        space = Space(space=TEST_SPACE_ID, space_name=TEST_SPACE_NAME,
                      space_description="Automated Files CRUD test space")
