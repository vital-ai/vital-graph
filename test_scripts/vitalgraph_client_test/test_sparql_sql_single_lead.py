...
Usage:
    ...
    python -m vitalgraph_client_test.test_sparql_sql_single_lead --file internal_data/lead_test_data/lead_0042.nt
"""
...
async def main():
    ...
    if args.file:
        ...
        lead_files = sorted((project_root / "internal_data" / "lead_test_data").glob("lead_*.nt"))
        if not lead_files:
