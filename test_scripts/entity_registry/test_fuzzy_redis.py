#!/usr/bin/env python3
"""
Redis integration test for EntityFuzzyIndex.
...
Usage:
    python test_scripts/entity_registry/test_fuzzy_redis.py
"""
...
def flush_test_keys(r):
    ...
    deleted = 0
    for key in r.scan_iter(match=b'*fuzzy_test*', count=1000):
        r.delete(key)
        deleted += 1
...
def run_tests():
    ...
    all_keys = list(r.scan_iter(match=b'*fuzzy_test*', count=5000))
