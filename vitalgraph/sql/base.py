...
class SQLGeneratorMixin(object):
    ...
    def regex_op(self, col, pattern):
        ...
        - On MySQL/SQLite (and others), falls back to 'REGEXP'.
        """
        # PostgreSQL uses '~' for regex; other dialects (MySQL/SQLite) use REGEXP
    ...
    def build_context_clause(self, context, table):
        ...
        if isinstance(context, REGEXTerm):
            ...
            # return self.regex_op(table.c.context, context.identifier)
