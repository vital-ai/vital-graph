...
endpoints for slots relative to frames

updating objects to set entity URI

setting creation, last updated properties
using a modified by property?
hasUserCreatorIdentifier

modifying frame and slots passing in entity uri and parent uri
